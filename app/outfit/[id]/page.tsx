    ...
    return (
      <main className="min-h-screen bg-gray-50 p-6 flex items-center justify-center text-black font-sans">
        ...
        <div className="bg-white border-4 border-black p-8 max-w-md w-full text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          ...
          <p className="font-bold text-gray-500 mt-2 uppercase text-xs">
            The stylistic formula you are looking for doesn't exist.
          </p>
          <Link
            href="/outfit"
            className="mt-6 inline-block bg-[#52D1F6] text-black font-black border-4 border-black px-5 py-2.5 text-xs uppercase tracking-wider shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all"
          >
            Back to Outfits ↩️
          </Link>
        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {outfit.items.map((item) => (
                <figure 
                  ...
                  className="relative h-60 bg-gray-50 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden group"
                >
                  <Image
                  ...
                  />
                  <div className="absolute bottom-2 left-2 bg-black text-white text-[9px] font-black px-2 py-0.5 border border-white uppercase">
                    {item.category}
                  </div>
                </figure>
              ))}
              ...
              >
                <div>
                  ...
                  <div className="p-4 space-y-2">
                    ...
                    <h3 className="font-black text-sm uppercase tracking-tight text-black line-clamp-1" title={item.name}>
                      {item.name}
                    </h3>
                  </div>
                </div>
